...
public class ManagePage {
...

	{
		...
		//JavascriptExecutor javascript = (JavascriptExecutor) driver;
		//javascript.executeScript("arguments[0].scrollIntoView(true)", topmenuradiobutton);// scroll down action until
		page.scrollIntoView(driver, topmenuradiobutton);																					// topmenu is found
		return this;
	}
